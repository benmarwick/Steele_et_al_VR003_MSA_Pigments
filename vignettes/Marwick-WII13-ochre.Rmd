...
```{r, run_functions, echo=FALSE, message=FALSE, cache=TRUE, results="hide", warning=FALSE}

# source('Marwick-WII13-ochre.R') # code for all the functions
# don't need it if this is the vignette for the package SteeleVR003MSAPigments
